...
public class Scan_Photo_Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spinner_document = (Spinner) findViewById(R.id.spinner_photo);
        ...
        spinner_quality.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                for(int i = 0 ; i< quality.length;i++){
                    kodakVeriteApp.setScanPhotoSettingQuality(quality[position]);
                }
            }
        ...
        spinner_document.setSelection(Arrays.asList(document).indexOf(kodakVeriteApp.getScanPhotoSettingDocument()));
